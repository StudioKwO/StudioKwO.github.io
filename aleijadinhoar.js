...
document.addEventListener("DOMContentLoaded", () => {
    const start = async () => {
        ...
        const mindarThree = new window.MINDAR.IMAGE.MindARThree({
            ...
            imageTargetSrc: './static/Aleijadinho/target/targets.mind',
            uiLoading: "no",
            uiScanning: "yes",
            // uiError: "yes",
            // filterMinCF:0, 
        ...
        loader.load( './static/Aleijadinho/font/helvetiker_regular.typeface.json', function ( _font ) {
            font = _font;
        } );
        materials = [
...
function AddLight(scene){
    new RGBELoader()
    .setPath('./static/Aleijadinho/hdri/')
